...
if (move_uploaded_file($tmp_name, $path_foto)) {
    $stmt = $pdo->prepare("INSERT INTO penulis (nama_depan, nama_belakang, user_name, password, foto) VALUES (?, ?, ?, ?, ?)");
    
    if ($stmt->execute([$nama_depan, $nama_belakang, $user_name, $password, $path_foto])) {
